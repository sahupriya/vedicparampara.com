var nvd3Charts = function() {
	...
	var startChart3 = function() {
		...
		d3.json('http://prachiinfra.in/steel/assets/plugins/nvd3/stackedAreaData.json', function(data){
			nv.addGraph(function() {
	...
	var startChart5 = function() {
		d3.json('http://prachiinfra.in/steel/assets/plugins/nvd3/multiBarHorizontalData.json', function(data) {
			nv.addGraph(function() {
	...
	var startChart6 = function() {
		d3.json("http://prachiinfra.in/steel/assets/plugins/nvd3/linePlusBarData.json", function(error, data) {
			nv.addGraph(function() {
	...
	var startChart7 = function() {
		d3.json('http://prachiinfra.in/steel/assets/plugins/nvd3/cumulativeLineData.json', function(data) {
			nv.addGraph(function() {
