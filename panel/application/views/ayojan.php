...
<ul class="breadcrumb">
    ...
    <li><a href="#">Add Bhavya Ayojan</a></li>    
</ul>
<!-- END BREADCRUMB -->
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="panel panel-default" style="<?=$form?'':'display:none;'?>" >
                <form class="form-horizontal" action="<?php echo site_url('site/ayojan_submit'); ?>" method="post" enctype="multipart/form-data">
                    <div class="panel-heading">
                        <h3 class="panel-title"><strong>Bhavya Ayojan Update</strong> Master</h3>
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            <div class="col-md-6 col-xs-12">
                                <label>Ayojan Name</label>
                                <div class="input-group">
                                    <span class="input-group-addon"><span class="fa fa-plane"></span></span>
                                    <input type="hidden" name="ayojan_id" value="<?=$data['ayojan_id']?>">
                                    <input type="text" name="ayojan_name" value="<?=$data['ayojan_name']?>" class="form-control" placeholder='Enter Name Of Ayojan' required>
                                </div>                                
                            </div>
                            <div class="col-md-6 col-xs-12">
                                <label>Price</label>
                            ...
                            <div class="col-md-6 col-xs-12">
                                <label>Ayojan Images (Multiple)</label>
                                <div class="input-group">
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title"><strong>Bhavya Ayojan</strong> List</h3>
                    <ul class="panel-controls">
                        ...
                        <table class="table datatable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?=site_url('site/change_ayojan_status').'?q='.$m->ayojan_id?>" onclick="return confirm('Do You want Change the Status Of This Ayojan')" class="btn <?=$m->status?'btn-primary':'btn-danger'?>"><i class="fa fa-edit"></i> <?=$m->status?'Active':'Inactive'?></a>
                                    </td>
                                    <td>
                                        <a href="<?=site_url('site/ayojan').'?m='.$m->ayojan_id?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
                                    </td>
                                    <td>
                                        <a href="#" onclick="open_msg('<?=site_url("site/ayojan_delete")."?q=".$m->ayojan_id; ?>');" class="btn btn-primary"><i class="fa fa-trash-o"></i></a>
                                    </td>
                                </tr>
                                <?php                            
                                }
