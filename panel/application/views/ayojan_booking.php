...
$( document ).ready(function() {
    $("#ayojan_booking").addClass('active');
});   
</script>
...
<ul class="breadcrumb">
    ...
    <li><a href="#">Update Ayojan Booking</a></li>    
</ul>
<!-- END BREADCRUMB -->
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title"><strong>Ayojan Booking</strong> List</h3>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <a href="<?=site_url('site/pandit_detail').'?q='.$r->panditId?>">
                                     ...
                                     <a href="<?=site_url('site/assign_pandit/ayojan').'?q='.$r->booking_id?>"  class="btn btn-info">Assign Pandit</a>
                                    </td>
                                    ...
                                    if ($r->status==='accepted' || $r->status==='pending') {
                                        echo '<a href="'.site_url('site/change_ayojan_booking_status').'?q='.$r->booking_id.'&s='.urlencode("Cancelled By Admin").'&g='.urlencode("ayojan_booking").'" onclick="return confirm(\'Do You really want to Cancel this Booking.\')" class="btn btn-primary"><i class="fa fa-times"></i>Cancel</a>';
                                    }
                                    echo '</td>';
                                    ?>
                                </tr>
